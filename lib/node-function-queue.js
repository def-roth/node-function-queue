...
var Worker = /** @class */ (function () {
    function Worker(releaseEvent) {
        var _this = this;
        this.run = function (task, resolve, onError) {
        ...
        this.runTimeout = function (task, resolve, onError, timeout) {
            if (onError === void 0) { onError = function (e) { return console.log(e); }; }
            if (timeout === void 0) { timeout = 30; }
            var rejectionPromise = _this.rejectAfter(timeout);
        ...
        this.rejectAfter = function (timeout) {
...
var NodeFunctionQueue = /** @class */ (function (_super) {
    ...
    function NodeFunctionQueue(id, concurrency) {
         ...
         * @returns {void}
         */
        _this._putWorker = function () {
            var worker = _this._createWorker();
            worker.release();
        };
        /**
        ...
        _this._getConfig = function (config) {
            var used = config ? __assign(__assign({}, _this._defaultConfig), config) : __assign({}, _this._defaultConfig);
            used.retry = 0;
            return used;
        };
        /**
         ...
         * @returns {void}
         * */
        _this._queue = function (task, resolve, reject, config) {
            ...
            if (_this._workers[0]) {
                ...
                _this._tasks.push({ task: task, resolve: resolve, reject: reject, config: config });
            }
        };
        /**
         ...
         * */
        _this.callbackQ = function (task, resolve, reject, config) {
            _this._queue(task, resolve, reject, _this._getConfig(config));
        };
        /**
         ...
         * @returns {Promise<unknown>} The result of the task
         * */
        _this.asyncQ = function (task, config) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
         ...
         * */
        _this.wrapQ = function (_function, config) {
            return function () {
                var args = [];
                ...
                return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    return [2 /*return*/, this.asyncQ(function () { return _function.apply(void 0, args); }, config)];
                }); });
            };
        };
        _this._id = id;
